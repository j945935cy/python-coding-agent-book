...
下一步進行全目錄逐章 API 核對與教學深化，建立章節程式碼片段的自動驗證，再進入完整版本範例與出版前稽核。章節結構、Python 語法、V1～V4 輸出、API 名稱、術語與學習段落稽核已完成。第一輪難度曲線審查位於 `reports/difficulty-review.md`；下一批依優先級補強第 11、14、17、6、7 章。