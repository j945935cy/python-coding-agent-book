...
本批補齊第 2、4、5、7、17 章，並加入 `examples/v04_events_parallel_cancel.py`。目前 18 個章節 Markdown 檔案皆已建立，另有 4 個可執行版本範例。第一輪難度曲線審查已完成，詳見 `reports/difficulty-review.md`；第 13、15、18 章已先完成補強。
