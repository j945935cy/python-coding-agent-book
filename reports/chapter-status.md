...
18 個章節均已完成第一輪出版篇幅擴寫，並對應可執行原型、自動化驗收或明確的已知限制。54 題練習均已提供解答方向；這代表書稿可進入全書技術編輯階段，尚未代表文字編輯或 EPUB 生產完成。
...
1. 執行全書第一輪技術編輯，統一重複警告、術語與章節銜接。
2. 執行第二輪文字編輯與反 AI 腔檢查。
3. 建立 EPUB 生產目錄、metadata、封面與建置腳本。
4. 執行 EPUBCheck、Ace by DAISY、閱讀器與 Google Play Books 預覽。
